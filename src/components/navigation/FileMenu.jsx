...
export function FileMenu() {
  ...
  const { proteinsById, upsertProtein, replaceCatalog, setActiveProteinId, clearSelection, selectedProteinIds } = useProteinStore();
      ...
      <MenubarMenu>
        ...
        <MenubarContent className={contentClass}>
          ...
          <MenubarItem className={itemClass} disabled>
            <span className="opacity-50">Invitar a Sesión en Vivo (Próximamente)</span>
          </MenubarItem>

...
export function DrawerHeader({ protein }) {
  ...
  return (
    <header className="border-b border-slate-100 px-7 pt-8 pb-5 overflow-hidden min-w-0">
      ...
      <h2 className="text-2xl font-black leading-tight tracking-tight text-slate-900 break-words min-w-0">
        {name}
      </h2>
      <p className="mt-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 truncate min-w-0">

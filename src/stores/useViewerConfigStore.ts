...
export const useViewerConfigStore = create((set) => ({
  // ── Viewer appearance ─────────────────────────────────────────────────
  viewerBackground: savedViewerBg,
  viewerRepresentation: "cartoon" as string,
  viewerLighting: "ao" as string,
  viewerColorScheme: savedColorScheme,

  // ── Drug Discovery Mode ───────────────────────────────────────────────
  drugDiscoveryMode: false,
  drugDiscoveryLens: "electrostatic-charge" as string,

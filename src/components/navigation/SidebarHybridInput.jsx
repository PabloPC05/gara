...
export function SidebarHybridInput({
  ...
  return (
    <input
      ...
      className={`w-full rounded-none border border-slate-200 px-3 py-1.5 text-sm text-slate-800 placeholder:text-slate-400 outline-none transition-colors focus:border-blue-300 ${className || ''}`}
    />
  )
}

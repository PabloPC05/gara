...
export function JobStatusPanel({ status }) {
  ...
  return (
    <div
      className={`mt-3 border ${cfg.border} rounded-none p-3 ${cfg.bg} shadow-sm`}
    >
      ...
      <div className="mb-2 h-1 w-full overflow-hidden rounded-none bg-slate-200">
        <div
          className={`h-full ${cfg.bar} ${cfg.barColor} transition-all duration-700 ease-in-out`}
        />
      </div>

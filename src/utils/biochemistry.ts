...
const HYDRO_PHILIC = [30, 64, 175] as const;
const HYDRO_NEUTRAL = [248, 250, 252] as const;
const HYDRO_PHOBIC = [153, 27, 27] as const;
...
const VOL_SMALL = [251, 191, 36] as const;
const VOL_MED = [234, 88, 12] as const;
const VOL_LARGE = [124, 58, 237] as const;
